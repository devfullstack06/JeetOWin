    ...
    <div className="jw-waitingOuter">
      <div className="jw-waitingPanel">
        <div className="jw-waitingContent">
          <div className="jw-waitingTitle">Rejected</div>
          <div className="jw-waitingText">
            Your Transfer is being Rejected. Please contact Customer Support for more information.
          </div>
          ...
          <div className="jw-transferDetails">
            ...
            <div className="jw-transferDetailRow">
              <div>Status:</div>
              <div className="jw-transferDetailValue">Rejected</div>
            </div>
          </div>
        </div>
